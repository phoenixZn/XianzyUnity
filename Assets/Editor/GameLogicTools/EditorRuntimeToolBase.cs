...
namespace IGTools
{
    public class EditorRuntimeToolBase
    {
        ...
        {
            //object res = HotfixFunc.CallPublicStaticMethod("Xease.CoreGame", "SysDebugCoreGame", "DebugNotify", cmdType, data);
            object res = null;
            return res;
        }
        ...
        {
            //object res = HotfixFunc.CallPublicStaticMethod("Xease.CoreGame", "GameUtility", "SendDebugToolCmd", cmdType, datas);
            object res = null;
            return res;
        }
        ...
        {
            //object res = HotfixFunc.CallPublicStaticMethod("Xease.CoreGame", "SysDebugADRecoder", "ADDebugNotify", cmdType, datas);
            object res = null;
            return res;
        }
