...
namespace Xease
{
    ...
    /// 虚拟按钮
    /// </summary>
    internal sealed class VirtualButton
    {
    ...
    /// 虚拟轴线
    /// </summary>
    internal sealed class VirtualAxis
    {
        public string Name { get; private set; }
    ...
    /// 默认输入服务实现
    /// </summary>
    internal sealed class InputService : IInputService, IEnvUpdate, IEnvAppPause
    {
        ...
        public void RegisterVirtualAxis(string name)
        {
            ...
            {
                G.LogError($"注册虚拟轴线失败：已经存在名为 {name} 的虚拟轴线！");
            }
            else
            {
        ...
        public void RegisterVirtualButton(string name)
        {
            ...
            {
                G.LogError($"注册虚拟按钮失败：已经存在名为 {name} 的虚拟按钮！");
            }
            else
            {
        ...
        public void LoadDevice(InputDeviceBase device)
        {
            if (device != null)
            {
                Device = device;
            ...
            {
                G.LogError($"LoadDevice 加载输入设备失败！");
            }
        }
        /// <summary>
        /// 清除所有输入状态
