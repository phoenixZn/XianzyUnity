    ...
    public sealed class StandardInputDevice : InputDeviceBase
    {
        ...
        public override void OnRun()
        {
            ...
            else
            {
                ...
                {
                    _upperLowerValue -= Time.deltaTime;
                }
                ...
                {
                    if (_upperLowerValue > 0)
                    {
                        _upperLowerValue -= Time.deltaTime;
                        _upperLowerValue = Mathf.Clamp(_upperLowerValue, 0, 1);
                    }
                    else if (_upperLowerValue < 0)
                    {
                        _upperLowerValue += Time.deltaTime;
                        _upperLowerValue = Mathf.Clamp(_upperLowerValue, -1, 0);
                    }
                }
