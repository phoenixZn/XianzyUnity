...
namespace HotUpdate.FP
{
    public class TimerSchedulerFP<TContext>
    {
        ...
        public TimerSchedulerFP(TContext context)
        {
            m_context = context;
        }
    ...
    public abstract class Task<TContext> : HeapItem
    {
        protected TimerSchedulerFP<TContext> m_scheduler;
        ...
        public TimerSchedulerFP<TContext> GetTaskScheduler()
        {
            return m_scheduler;
        }
        public void SetTaskScheduler(TimerSchedulerFP<TContext> scheduler)
        {
