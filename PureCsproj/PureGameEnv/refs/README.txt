...
工程内 shim（不向 Assets 拷贝）：src/shim/AsyncAssetViewWrapper.Shim.cs、GameEntry.Shim.cs。UniTask 由 PureCsproj/UniTask 引用 Plugins/UniTask/Runtime 无 Unity 子集（UNITASK_NETCORE）。详见仓库 cursor_doc/PureGameEnv-构建说明.md。
