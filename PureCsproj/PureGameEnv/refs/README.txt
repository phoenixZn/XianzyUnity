...
工程内 shim（不向 Assets 拷贝）：DesperateDevs.Utils.Shim.cs、KLogger.Shim.cs、GEnv.Partial.Shim.cs；并 Compile Remove Product/GEnv.Ex.cs。详见仓库 cursor_doc/PureGameEnv-构建说明.md。
